...
import {
  ...
  DOMAFRAIS_CONFIG, DOMAFRAIS_BOF_CONFIG, POMONA_TERRE_AZUR_CONFIG,
} from '../data';
...
const SupplierOrderPage: React.FC<SupplierOrderPageProps> = ({ state }) => {
  ...
  const _configDefaults: Record<string, SupplierConfig> = {
    ...
    domafrais: DOMAFRAIS_CONFIG, domafrais_bof: DOMAFRAIS_BOF_CONFIG, pomona_terre_azur: POMONA_TERRE_AZUR_CONFIG,
  };
