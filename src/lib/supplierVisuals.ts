  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" preserveAspectRatio="xMidYMid slice">
    <defs>
      <linearGradient id="g" x1="0" y1="0" x2="1" y2="1">
        ...
        <stop offset="55%" stop-color="${colors.base}" stop-opacity="0.9"/>
        <stop offset="100%" stop-color="#050505" stop-opacity="1"/>
      </linearGradient>
    </defs>
    <rect width="800" height="800" fill="url(#g)"/>
    <circle cx="670" cy="160" r="180" fill="${colors.accent}" opacity="0.16"/>
    <circle cx="180" cy="160" r="150" fill="#ffffff" opacity="0.05"/>
    <path d="M-20 610 Q 160 520 300 610 T 640 610 T 840 610 L 840 840 L -20 840 Z" fill="#000000" opacity="0.32"/>
    <path d="M-20 670 Q 120 590 280 680 T 600 690 T 840 650 L 840 840 L -20 840 Z" fill="#000000" opacity="0.18"/>
    <g opacity="0.18" fill="none" stroke="${colors.line}" stroke-width="16" stroke-linecap="round" stroke-linejoin="round">
      ${motif}
    </g>
    <g opacity="0.12" fill="${colors.line}">
      <rect x="55" y="75" width="170" height="18" rx="9"/>
      <rect x="55" y="105" width="110" height="10" rx="5"/>
    </g>
  </svg>`;

  const image = makeSvgDataUri(svg.trim());
  const overlay = `linear-gradient(180deg, rgba(0,0,0,0.05) 0%, rgba(0,0,0,0.12) 45%, rgba(0,0,0,0.75) 100%), ${image}`;
  return {
    key,
    name,
    description,
    ...
    thumbStyle: {
      backgroundImage: `linear-gradient(180deg, rgba(0,0,0,0.1) 0%, rgba(0,0,0,0.45) 100%), ${image}`,
      backgroundSize: 'cover',
      backgroundPosition: 'center',
    },
  };
...
export const SUPPLIER_VISUAL_PRESETS: SupplierVisualPreset[] = [
  ...
  visual(
    ...
    'from-fuchsia-400/40 via-rose-500/20 to-transparent',
  ),
  visual(
    'grill-fire',
    'Grill & braise',
    ...
    'from-orange-400/40 via-red-500/20 to-transparent',
  ),
  visual(
    'farm-fresh',
    'Frais & nature',
    ...
    'from-lime-300/40 via-emerald-500/20 to-transparent',
  ),
  visual(
    'ice-blue',
    'Surgelé premium',
    ...
    'from-sky-300/40 via-cyan-500/20 to-transparent',
  ),
  visual(
    'market-green',
    'Marché végétal',
    ...
    'from-green-300/40 via-emerald-500/20 to-transparent',
  ),
  visual(
    'spice-gold',
    'Épicerie dorée',
    ...
    'from-yellow-300/40 via-amber-500/20 to-transparent',
  ),
  visual(
    'night-premium',
    'Noir premium',
    ...
    'from-violet-300/40 via-purple-500/20 to-transparent',
  ),
];
