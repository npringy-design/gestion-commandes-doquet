...
export const SUPPLIER_VISUAL_PRESETS: SupplierVisualPreset[] = [
  ...
  photoPreset('new-legumes-01',       'Légumes 02',            newLegumes01),
  photoPreset('new-legumes-02',       'Légumes 03',            newLegumes02),
...
export const DEFAULT_SUPPLIER_VISUAL_KEY: SupplierVisualKey = 'new-grill-01';
