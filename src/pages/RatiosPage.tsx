    ...
    <div className="min-h-screen bg-[#f1f5f9] p-2 lg:p-4 pb-24 lg:pb-12 font-sans text-[10px]">
      ...
      <div className="hidden lg:block relative">
        <div
          ...
          className="bg-[#f8efe6] border border-[#d9c2b1] rounded-[32px] shadow-[0_10px_28px_rgba(90,55,35,0.10)] overflow-x-auto overflow-y-visible custom-scrollbar"
        >
          <table className="border-collapse min-w-[3400px]">
            <thead>
              <tr className="bg-slate-900 text-white">
                ...
                <th className="border-r border-slate-700 p-5 text-left w-[420px] sticky left-0 z-30 bg-slate-900 font-black text-sm shadow-[8px_0_12px_rgba(0,0,0,0.08)]" rowSpan={3}>
            ...
            <tbody>
              {displayedRatioProducts.map((p, idx) => {
                ...
                return (
                  ...
                  >
                    <td className={`border-r border-slate-200 text-center ${selectedProductIds.has(p.id) ? 'bg-[#f8efe6]' : 'bg-[#f8efe6]'}`}>
                    ...
                    <td className={`border-r border-slate-200 p-0 sticky left-0 z-20 font-black uppercase text-[11px] bg-[#fbf5ee] shadow-[8px_0_12px_rgba(0,0,0,0.05)]`}>
                    ...
                    <td className={`border-r border-slate-200 p-0 ${state.activeMappingId === p.id ? 'z-[9999] relative' : ''} bg-[#fbf5ee]`}>
