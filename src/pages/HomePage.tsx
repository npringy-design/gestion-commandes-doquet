...
>
            <button
              ...
              className="group w-full max-w-[320px] mx-auto bg-white p-3 sm:p-4 lg:p-5 rounded-[30px] shadow-2xl hover:scale-105 transition-all border-4 border-transparent hover:border-red-600"
            >
            ...
            {!isMobile && canAccessStatsPage(profile) && (
              <button
                ...
                className="group w-full max-w-[320px] mx-auto bg-white p-3 sm:p-4 lg:p-5 rounded-[30px] shadow-2xl transition-all border-4 border-transparent hover:scale-105 hover:border-amber-500"
                title="Paramètres"
              >
            ...
            <button
              ...
              className="group w-full max-w-[320px] mx-auto bg-white p-3 sm:p-4 lg:p-5 rounded-[30px] shadow-2xl hover:scale-105 transition-all border-4 border-transparent hover:border-orange-600"
            >
