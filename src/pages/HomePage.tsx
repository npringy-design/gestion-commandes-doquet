        ...
        <div className="w-full max-w-[1800px]">
          ...
          >
            <button
              ...
              className="group bg-white/95 backdrop-blur-sm rounded-[32px] lg:rounded-[40px] shadow-2xl border-4 border-transparent hover:border-red-600 hover:scale-[1.02] transition-all px-5 py-6 sm:px-6 sm:py-7 lg:px-8 lg:py-10 min-h-[210px] lg:min-h-[250px] flex flex-col items-center justify-center"
            >
            ...
            {!isMobile && canAccessStatsPage(profile) && (
              <button
                ...
                className="group bg-white/95 backdrop-blur-sm rounded-[32px] lg:rounded-[40px] shadow-2xl border-4 border-transparent hover:border-amber-500 hover:scale-[1.02] transition-all px-5 py-6 sm:px-6 sm:py-7 lg:px-8 lg:py-10 min-h-[210px] lg:min-h-[250px] flex flex-col items-center justify-center"
                title="Paramètres"
              >
            ...
            <button
              ...
              className="group bg-white/95 backdrop-blur-sm rounded-[32px] lg:rounded-[40px] shadow-2xl border-4 border-transparent hover:border-orange-600 hover:scale-[1.02] transition-all px-5 py-6 sm:px-6 sm:py-7 lg:px-8 lg:py-10 min-h-[210px] lg:min-h-[250px] flex flex-col items-center justify-center"
            >
